...
const SubNav:React.FC<{contractMap:IChainContractConfigMap,loadChainLoading?:boolean,loadNFTListLoading?:boolean,status:null | 'error' | 'waring' | 'success' | 'chainNotSupport'}> = (props)=>{
    const {contractMap,loadChainLoading,loadNFTListLoading,status} = props;
